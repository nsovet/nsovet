      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1557491707029");
          });
      }
    }
...
// extracted by mini-css-extract-plugin
module.exports = {"promisesWrapper":"_1nBNq0CpJCBE2e5XdeAb8G","promises":"_2gKXSglENg-RdbqAAX377-","promisesItems":"_221H0vscTTYbVi9_b2eEnr","promisesItem":"_3OIxEF_XFLaebL1hJm60bG","promisesCall":"TfcVh56c78_77iXY7W5GE"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1557487893061");
          });
      }
    }
